        ...
        <div class="feature-post-block">
            <?php
                ...
                if( ! $posts_column_post_query->have_posts() ) {
                    esc_html_e( 'No posts found', 'wp-minimalist' );
                }
                $post_count = 0;
                                ...
                                <div class="first_post_inner" style="back">
                                    <a class="card__cover" href="<?php the_permalink(); ?>">
                                        <?php if( has_post_thumbnail() ) : ?>
                                            <img src="<?php the_post_thumbnail_url('wp-minimalist-category-feature'); ?>" alt="<?php the_title_attribute(); ?>" loading="<?php wp_minimalist_lazy_load_value(); ?>"/>
                                        <?php endif; ?>
                                    </a>
