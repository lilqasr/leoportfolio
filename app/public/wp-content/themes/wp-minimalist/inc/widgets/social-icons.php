...
/**
 * Adds wp_minimalist_Social_Icons_Widget widget.
 */
class wp_minimalist_Social_Icons_Widget extends WP_Widget {
    /**
     * Register widget with WordPress.
     */
    public function __construct() {
        parent::__construct(
            'wp_minimalist_social_icons_widget',
            esc_html__( 'TSB : Social Icons', 'wp-minimalist' ),
            array( 'description' => __( 'The list of social icons.', 'wp-minimalist' ) )
        );
    }
    ...
    function widget_fields() {
        return array(
                array(
                    ...
                    'default'   => esc_html__( 'Find Me On', 'wp-minimalist' )
                ),
            );
    }
    ...
    ?>
            <div class="refer-note">
                <p>
                    <?php esc_html_e( 'Manage social icons from customizer ', 'wp-minimalist' ); ?>
                    <a href="<?php echo esc_url( admin_url( 'customize.php?autofocus[control]=social_icons' ) ); ?>" target="_blank"><?php esc_html_e( 'go to manage social icons', 'wp-minimalist' ); ?></a>
                </p>
            </div>
    <?php
    }
