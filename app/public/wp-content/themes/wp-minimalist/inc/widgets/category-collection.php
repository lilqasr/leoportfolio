<?php
/**
 * Adds wp_minimalist_Category_Collection_Widget widget.
 */
class wp_minimalist_Category_Collection_Widget extends WP_Widget {
    /**
     * Register widget with WordPress.
     */
    public function __construct() {
        parent::__construct(
            'wp_minimalist_category_collection_widget',
            esc_html__( 'TSB : Category Collection', 'wp-minimalist' ),
            array( 'description' => __( 'A collection of post categories.', 'wp-minimalist' ) )
        );
    }
                                        ...
                                        if( $categories_count ) {
                                            ...
                                            echo absint( $cat_count );
                                                ...
                                                <span class="article_text">
                                                    <?php echo esc_html( 'Articles', 'wp-minimalist'); ?>
                                                </span>
                                                <?php
                                            echo '</span>';
                                        }
    ...
    function widget_fields() {
        ...
        return array(
                array(
                    ...
                    'default'   => esc_html__( 'Category Collection', 'wp-minimalist' )
                ),
                array(
                    'name'      => 'posts_categories',
                    'type'      => 'multicheckbox',
                    'title'     => esc_html__( 'Post Categories', 'wp-minimalist' ),
                    'description'=> esc_html__( 'Choose the categories to display', 'wp-minimalist' ),
                    'options'   => $categories_options
                ),
                array(
                    'name'      => 'categories_title',
                    'type'      => 'checkbox',
                    'title'     => esc_html__( 'Show categories title', 'wp-minimalist' ),
                    'default'   => true
                ),
                array(
                    'name'      => 'categories_count',
                    'type'      => 'checkbox',
                    'title'     => esc_html__( 'Show categories count', 'wp-minimalist' ),
                    'default'   => true
                )
            );
    }
...
} // class wp_minimalist_Category_Collection_Widget