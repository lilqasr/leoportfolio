...
( function( $ ) {
	// logo width
	wp.customize( 'wp_minimalist_site_logo_width', function( value ) {
		value.bind( function( to ) {
			$( '.logo_wrap img.custom-logo' ).css( "max-width", to + "px" );
		});
	});
	...
	wp.customize( 'header_social_color_group', function( value ) {
		value.bind( function( to ) {
			...
			if(to.hover) {
				$( "body header .social a i" ).mouseover(function() {
					$(this).css({
						color: to.hover
					})
				})
				$( "body header .social a i" ).mouseout(function() {
					var _this = $(this);
					if(to.color) {
						_this.css({
							color: to.color
	...
	wp.customize( 'footer_three_column_background_color', function( value ) {
		value.bind( function( to ) {
			if( to[to.type] ) {
				$( '#wp-minimalist-footer-three-column-section' ).css( 'background', to[to.type] )
			} else {
				$( '#wp-minimalist-footer-three-column-section' ).removeAttr( 'style' )
			}
		});
	});
